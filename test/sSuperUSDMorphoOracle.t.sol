...
contract sSuperUSDMorphoOracleTest is Test {
    ...
    function test_UpdatePrice_Fresh() public {
        ...
        int256 expectedEMA = (int256(newPrice) * int256(multiplierValue) + 
                             initialEMA * int256(10000 - multiplierValue)) / int256(10000);
    ...
    function test_UpdatePrice_Stale() public {
        ...
        uint256 multiplierValue = oracle.multiplier();
        int256 expectedEMA = (fallbackPrice * int256(multiplierValue) + 
                             initialEMA * int256(10000 - multiplierValue)) / int256(10000);
    ...
    function test_MultipleUpdates() public {
        ...
        console.log("initial upper and lower", oracle.allowedExchangeRateChangeUpper(), oracle.allowedExchangeRateChangeLower());
        ...
        int256 expectedMA = (price * int256(multiplier) + 
                            currentMA * int256(10000 - multiplier)) / 10000;
        ...
        console.log("second upper and lower", oracle.allowedExchangeRateChangeUpper(), oracle.allowedExchangeRateChangeLower());

        primaryOracle.setRate(int256(uint256(currentMA).mulDivDown(10200, 1e4))); // +2%
        (,price,,,) = fallbackOracle.latestRoundData();
        
        expectedMA = (price * int256(multiplier) + 
                     currentMA * int256(10000 - multiplier)) / 10000;
        ...
        console.log("third upper and lower", oracle.allowedExchangeRateChangeUpper(), oracle.allowedExchangeRateChangeLower());
        ...
        console.log("fourth upper and lower", oracle.allowedExchangeRateChangeUpper(), oracle.allowedExchangeRateChangeLower());
